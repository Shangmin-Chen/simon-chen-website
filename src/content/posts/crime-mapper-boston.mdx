...
How can we predict where crimes will happen to help cities allocate police resources better? That's the question behind **CrimeMapper-Boston**, a machine learning system that forecasts crime counts for each police district in Boston and finds crime hotspots.

The system analyzes **174,421 crime records** from **14 police districts** over **824 days**, using Facebook's Prophet forecasting model to predict future crime patterns.
...
**Project Repository**: <a href="https://github.com/Shangmin-Chen/Crime-Analytics-Forecasting-Platform" target="_blank" rel="noopener noreferrer">Github</a>

**Data Source**: <a href="https://data.boston.gov/dataset/crime-incident-reports-august-2015-to-date-source-new-system/resource/b973d8cb-eeb2-4e7e-99da-c92938efc9c0" target="_blank" rel="noopener noreferrer">Boston.gov Crime Data</a>
